...
void main() {
    ...
    //seleziono step 1/256 - Durata periodo PWM è 256 colpi
    PR2=255;
    ...
    // Seleziono il clock dell'ADC, Fosc/16 (TAD = 16/8M)
    ADCON2.ADCS0 = 1;
    ADCON2.ADCS1 = 0;
    ADCON2.ADCS2 = 1;

    // Seleziono la velocità di acquisizione 8Tad = 16us > 7.45us
    ADCON2.ACQT0 = 0;
    ADCON2.ACQT1 = 0;
    ADCON2.ACQT2 = 1;
